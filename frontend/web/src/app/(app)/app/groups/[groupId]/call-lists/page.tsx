    ...
    <div className="mx-auto w-full max-w-md md:max-w-none space-y-4 md:space-y-6 pb-24 md:pb-0">
      ...
      <div className="md:hidden px-1 space-y-3">
        <div className="flex items-start justify-between gap-3">
          <div>
            <h1 className="text-2xl font-bold text-[var(--groups1-text)] leading-tight">
              {groupName} Call Lists
            </h1>
            ...
            <>
              ...
              <div className="md:hidden space-y-3">
                {filteredCallLists.map((callList) => {
                  const detailUrl = `/app/call-lists/${callList.id}?groupId=${groupId}`;
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0">
                            ...
                            <div className="mt-1 text-xs text-[var(--groups1-text-secondary)] truncate">
                              {callList.group?.batch?.name || "No batch"}
                            </div>
                          </div>
