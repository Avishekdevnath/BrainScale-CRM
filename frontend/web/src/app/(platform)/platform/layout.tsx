...
import { Loader2, LayoutDashboard, Building2, Users, ArrowLeft, Shield, ScrollText, MessageSquare, SlidersHorizontal, Megaphone, Clock3 } from "lucide-react";
...
export default function PlatformLayout({ children }: { children: React.ReactNode }) {
  ...
  const nav = [
    ...
    { href: "/platform/usage", label: "Usage", icon: Clock3 },
  ];
