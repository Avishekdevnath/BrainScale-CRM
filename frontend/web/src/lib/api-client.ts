...
export class ApiClient {
  ...
  platformRestoreWorkspace(id: string) {
    return this.request<{ id: string }>(`/platform/workspaces/${id}/restore`, { method: "POST" });
  }
  ...
  platformUpdateUser(id: string, body: { name: string }) {
    return this.request<{ id: string }>(`/platform/users/${id}`, {
      method: "PATCH", body: JSON.stringify(body),
    });
  }
  ...
  platformReplyFeedback(id: string, reply: string) {
    return this.request<{ id: string }>(`/platform/feedback/${id}/reply`, {
      method: "PATCH", body: JSON.stringify({ reply }),
    });
  }
  platformSetFeedbackStatus(id: string, status: "OPEN" | "RESOLVED") {
    return this.request<{ id: string }>(`/platform/feedback/${id}/status`, {
  ...
  getPlatformFeatures() {
    return this.request<{ features: Record<string, boolean> }>(`/platform/features`, { method: "GET" });
  }
  updatePlatformFeatures(feature: string, enabled: boolean) {
    return this.request<{ features: Record<string, boolean> }>(`/platform/features`, {
  ...
  getWorkspacePlatformFeatures() {
    return this.request<{ features: Record<string, boolean> }>(`/workspace/platform-features`, { method: "GET" });
  }
  getMyFeedback() {
    return this.request<Array<{
      id: string; type: string; status: string; message: string;
